...
<div id="content">															<!--Contenido a mostrar/ocultar-->							
	<div id="content-1">													<!--Contenido de la Pestaña 1-->
		<table>
			<tr>
				<td><img class="img-title-tab" src="img/menu/boletas.png" width="40px" height="40px" /></td>
				<td><p class="title-tab">Boletas</p></td>
			</tr>
		</table>
	...
	<div id="content-2">													<!--Contenido de la Pestaña 2-->
		<table>
			<tr>
				<td><img class="img-title-tab" src="img/menu/boletas.png" width="40px" height="40px" /></td>
				<td><p class="title-tab">Ver detalles</p></td>
			</tr>
		</table>
		<hr class="separator-title">
		<p class="content-info">
